...
function encConfigReadFromUI(purpose) {
    ...
    if (skipInp) cfg.skip    = parseInt(skipInp.value) || 8;
    if (lenInp)  cfg.length  = parseInt(lenInp.value) || 25;
