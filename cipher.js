...
module.exports = { Charset, encryptVersion, decryptVersion,
  generators: { genBlockMix, genBitmixKeys, genCellular, genRC4, genLFSR, genPolynomial, genPRNG, genModSquare, genLogistic },
  buildSbox, bitmixForward, bitmixInverse };
